...
SYSTEM_PROMPT = (
    ...
    "TIPO DI ARTICOLI:\n"
    "News giornaliere concrete sul mondo Linux: nuove versioni di distro, "
    "aggiornamenti kernel, novita' desktop environment KDE/GNOME, "
    "tool e applicazioni Linux, notizie sulla privacy e sicurezza su Linux, "
    "cambiamenti nell'ecosistema Linux.\n\n"
    "STRUTTURA OBBLIGATORIA:\n"
    "1. Titolo SEO 50-65 caratteri con keyword principale\n"
    "2. Primo paragrafo: la notizia concreta. Cosa e' successo, quando, chi\n"
    "3. Secondo paragrafo: cos'e' questa distro/software/tecnologia "
    "(spiegalo come se il lettore non lo conoscesse)\n"
    "4. H2 breve e specifico (max 5 parole): le novita' principali\n"
    "5. Paragrafo dettagli: cosa cambia concretamente per l'utente Linux\n"
    "6. H2 breve e specifico (max 5 parole): impatto pratico CREATIVO\n"
    "   NON usare mai frasi generiche. Esempi corretti: "
    "'Ubuntu 26.04 sul tuo desktop', 'KDE Plasma e la tua produttivita', "
    "'Fedora 42 e i tuoi pacchetti', 'Il kernel 7.x e la tua privacy'\n"
    "7. Paragrafo impatto: perche' e' importante per chi usa Linux ogni giorno\n"
    ...
    "<!-- /wp:paragraph -->\n"
    "<!-- wp:paragraph -->\n"
    "<p>[Secondo paragrafo: cos'e' questa distro/software]</p>\n"
    "<!-- /wp:paragraph -->\n"
    "<!-- wp:heading {\"level\":2} -->\n"
...
def generate_digest(articles):
    ...
    user_prompt = (
        "Ecco " + str(len(articles)) + " news Linux di oggi per IncastroPC.\n\n"
        + news_block +
        "Scrivi un articolo italiano per ognuna seguendo il formato. "
        "Ricorda: Linux deve essere facile per tutti. "
        "Spiega sempre cos'e' la distro/software di cui parli. "
